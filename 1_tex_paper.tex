...
\begin{thm}[Recurrence Relation and Explicit
Formula]\label{thrm:recurrencesb_2}

For $n > (s+1)b+1$,  the $n^{\text{th}}$ term of the $(s,b)$-Generacci
sequence satisfies
\be
a_n \ = \ a_{n-b}+ba_{n-(s+1)b} \ = \  c_1\lambda_1^n \left[1 +
O\left((\lambda_2/\lambda_1)^n\right)\right],
\ee
...
\be
\frac{p_N}{q_N} \ = \ \prod_{p \le N} \left(1 -
\frac1{p^2}\right)^{-1} \ = \ \prod_{p \le N} \left(1 + \frac{1}{p^2 -
1}\right).
\ee

\lipsum[10]

\be \left|\frac{p_N}{q_N} - \frac{\pi^2}6\right| \ = \ \frac{p_N}{q_N}
\left|1 - \prod_{p > f(N)} \left(1 + \frac{1}{p^2 - 1}\right)\right|.
\ee
